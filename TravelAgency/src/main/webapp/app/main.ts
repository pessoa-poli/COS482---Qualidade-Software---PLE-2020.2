...
import TravelAgencyProcessService from '@/entities/travel-agency-process/travel-agency-process.service';
...
new Vue({
  ...
  provide: {
    ...
    travelAgencyProcessService: () => new TravelAgencyProcessService(),
