      ...
      <div class="xcontainer">
        <div class="row px-3">
            ...
            <slot name="details">
              <div class="form-group">
                <label
                  ...
                  v-text="$t('travelAgencyApp.processInstance.businessKey')"
          ...
          <div class="col summary">
            <div class="label" v-text="$t('travelAgencyApp.processInstance.status')">Status</div>
            ...
            <hr />
            <div class="label" v-text="$t('travelAgencyApp.processInstance.processDefinition')">Process Definition</div>
            ...
            <hr />
            <div class="label" v-text="$t('travelAgencyApp.processInstance.camundaProcessInstanceId')">Camunda Process Instance Id</div>
            <div class="link" v-if="processInstance.camundaProcessInstanceId">
              {{ processInstance.camundaProcessInstanceId }}
            </div>
            <hr />
            <div class="label" v-text="$t('travelAgencyApp.processInstance.camundaProcessDefinitionId')">Camunda Process Definition Id</div>
            <div class="link" v-if="processInstance.camundaProcessDefinitionId">
              {{ processInstance.camundaProcessDefinitionId }}
            </div>
            <div class="link" v-if="processInstance.processDefinition">
              <hr />
              <div class="label" v-text="$t('travelAgencyApp.processDefinition.bpmnProcessDefinitionId')">BPMN Process Definition Id</div>
