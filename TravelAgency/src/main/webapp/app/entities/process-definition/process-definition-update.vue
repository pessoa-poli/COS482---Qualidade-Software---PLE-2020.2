  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2
          id="travelAgencyApp.processDefinition.home.createOrEditLabel"
          data-cy="ProcessDefinitionCreateUpdateHeading"
          v-text="$t('travelAgencyApp.processDefinition.home.createOrEditLabel')"
        >
        ...
        <div>
          ...
          <div class="form-group" v-if="processDefinition.id">
            <label class="form-control-label" v-text="$t('travelAgencyApp.processDefinition.name')" for="process-definition-name"
              >Name</label
            >
          ...
          <div class="form-group">
            <label
              ...
              v-text="$t('travelAgencyApp.processDefinition.specificationFile')"
